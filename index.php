...
<html lang="en">
    ...
    <body>
                    ...
                    <div class="col-lg-4 mt-sm-30 mb-sm-30 mb-xs-30 mt-xs-30">
                        <div class="styl_box">
                            <div class="single_analize__block text-center">
                                ...
                                <h2>Design & Planting</h2>
                                <p>
                                    We are experts in this industry with over 100 years of experience. What that means is you are going to get right solution, experts also recommand us.
                                </p>
                                <a href="#!" class="btn-text btn_new">Read More</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="box_content__block">
                                        ...
                                        <h2>Experienced <span>Lorem ipsum dolor sit amet.</span></h2>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="box_content__block">
                    ...
                    <div class="col-lg-6 pull-lg-6 mt-sm-30 mt-xs-30">
                        <img src="assets/images/gard-left.png" alt="" class="img-responsive">
                    </div>
                </div>
            </div>
        </section>
        ...
        <!-- Project Section -->
        <div class="padding project-section gray-bg ptb-xs-40">
            <div class="container">
                    ...
                    <div class="col-sm-12 col-lg-6 pr-0 plr-xs-15 mb-xs-30">
                        ...
                        <div class="about-block black-bg light-color hover-bg d-flex align-items-center flex-column flex-sm-row">
                            <div class="fl half-width">
                                <img class="img-responsive" src="assets/images/project/project5.jpg" alt="Photo">
                            </div>
                            <div class="text-box padding-20 d-flex flex-column half-width text-center text-md-left">

                                <div class="box-title">

                                    <h3 class="mt-0"><a href="#">Planing</a></h3>
                                </div>
                        ...
                        <div class="about-block black-bg light-color hover-bg d-flex align-items-center flex-column flex-sm-row">
                            ...
                            <div class="text-box padding-20 d-flex flex-column half-width text-center text-md-right text-lg-left">
                                ...
                                <div class="box-title">
                                    ...
                                    <h3 class="mt-0"><a href="#">Designing</a></h3>
                                </div>
                        ...
                        <div class="about-block black-bg light-color hover-bg d-flex align-items-center flex-column flex-sm-row">
                            ...
                            <div class="text-box padding-20 d-flex flex-column half-width text-center text-md-left text-lg-right">
                                ...
                                <div class="box-title">
                                    ...
                                    <h3 class="mt-0"><a href="#">Development</a></h3>
                                </div>
                    ...
                    <div class="col-sm-12 col-lg-6 pl-0 plr-xs-15 mb-xs-30">
                        <div class="about-block black-bg light-color hover-bg d-flex align-items-center flex-column flex-sm-row">
                            <div class="fr half-width flex-md-last">
                                <img class="img-responsive" src="assets/images/project/project4.jpg" alt="Photo">
                            </div>
                ...
                <div id="project">
                    <div class="item">
                        <div class="clearfix bg-area">
                            <div class="image-box">
                                <img class="img-responsive" src="assets/images/project/1.jpg" alt="Photo">
                    ...
                    <div class="item">
                        <div class="clearfix bg-area">
                            <div class="image-box">
                                <img class="img-responsive" src="assets/images/project/2.jpg" alt="Photo">
                    ...
                    <div class="item">
                        <div class="clearfix bg-area">
                            <div class="image-box">
                                <img class="img-responsive" src="assets/images/project/3.jpg" alt="Photo">

                            </div>
                            <div class="content-box">

                                <h4>Planting & Design</h4>
                                <p>
                                    Lorum ipsum iure reprhe pu nderit sit amet,consectetur neque.
                                </p>
                                <div class="link">
                    ...
                    <div class="item">
                        <div class="clearfix bg-area">
                            <div class="image-box">
                                <img class="img-responsive" src="assets/images/project/4.jpg" alt="Photo">
                    ...
                    <div class="item">
                        <div class="clearfix bg-area">
                            <div class="image-box">
                                <img class="img-responsive" src="assets/images/project/5.jpg" alt="Photo">
                    ...
                    <div class="item">
                        <div class="clearfix bg-area">
                            <div class="image-box">
                                <img class="img-responsive" src="assets/images/project/6.jpg" alt="Photo">
                    ...
                    <div class="col-lg-8 mt-sm-30 mt-xs-30">
                        <div class="row">
                            <div class="col-md-8 offset-md-2 offset-lg-0">
                                <div class="creative_heading light-color pb-30 text-center text-lg-left">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="media choose_box">
                                    ...
                                    <div class="media-body">
                                        <h4 class="mt-0"><a href="#">Rubbish Removal</a></h4>
                            ...
                            <div class="col-md-6">
                                <div class="media choose_box">
                                    <div class="d-flex mr-3 mt-4 mt-sm-2 mt-xs-2">
                                        <i class="flaticon-people sub-color fontsize_28"></i>
                                    </div>
                                    <div class="media-body">
                                        <h4 class="mt-0"><a href="#">Lawn Moving</a></h4>
                                        <p>
                                            Lorem ipsum dolor sit amet con sectetur adipisicing elit
                                        </p>
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="media choose_box">
                                    <div class="d-flex mr-3 mt-4 mt-sm-2 mt-xs-2">
                                        <i class="flaticon-nature-1 fontsize_28"></i>
                                    </div>
                                    <div class="media-body">
                                        <h4 class="mt-0"><a href="#">Garden Care</a></h4>
                                        <p>
                                            Lorem ipsum dolor sit amet con sectetur adipisicing elit
                                        </p>
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="media choose_box">
                                    ...
                                    <div class="media-body">
                                        <h4 class="mt-0"><a href="#">Insect Control</a></h4>
                                        <p>
                                            Lorem ipsum dolor sit amet con sectetur adipisicing elit
                                        </p>
                                    </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 mb-xs-30 mb-sm-30">
                        <div class="blog-post">
                            ...
                            <div class="post-header">
                                <h3><a href="blog-detail.html">Lorem Ipsum is simply text..</a></h3>
                            </div>
                    ...
                    <div class="col-lg-4 mb-xs-30 mb-sm-30">
                        <div class="blog-post">
                            <div class="post-media img-scale">
                                <img src="assets/images/blog/img22.jpg" alt="">
                            </div>
                            <div class="post-meta">
                    ...
                    <div class="col-lg-4 mb-xs-30 mb-sm-30">
                        <div class="blog-post">
                            <div class="post-media img-scale">
                                <img src="assets/images/blog/img33.jpg" alt="">
                            </div>
                            <div class="post-meta">
                                <span>by <a href="javascript:avoid(0);">Admin</a>,</span><span> <a href="javascript:avoid(0);"><i class="fa fa-comment-o"></i> 25</a>,</span><span> <a href="javascript:avoid(0);"><i class="fa fa-heart-o"></i> 57</a>,</span>
                            </div>
