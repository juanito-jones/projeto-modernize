...
<html lang="en">
	<head>
		...
		<link href="assets/css/header3.css" rel="stylesheet" type="text/css">
		<link href="assets/css/footer3.css" rel="stylesheet" type="text/css" />
				...
				<div class="reletiv_box">
					<div class="container">
						<div class="row">
							<div class="col-md-3">
								<div class="logo">
									<a href="javascript:avoid(0);"><img src="assets/images/logo3.png" alt="Mega business"></a>
								</div>
								<!-- Phone Menu button -->
				...
				<div class="banner_slide">
					<div class="slide_box">
						<div class="pull-left">
							...
							<a href="#!" class="btn btn-text dark_btn mt-15">Purchase Owl Construction</a>
						</div>
					</div>
					
					<div class="slide_box">
						<div class="pull-left">
							<h1>Owl Cost effective services!</h1>
							<p>
								Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy.
							</p>
							<a href="#!" class="btn btn-text dark_btn mt-15">Purchase Owl Construction</a>
				...
				<div class="row">
					<div class="col-lg-4 mb-xs-30">
						<div class="about_comp">
							...
							<h2>Wecome to Garden</h2>
							<p>
								Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy.
							</p>
							<a href="#!" class="btn btn-text bg_btn mt-15">About Company</a>
						</div>
					</div>

					<div class="col-lg-4 col-md-6 mt-sm-30 mb-xs-30">
						<div class="about_box">
							<figure><img src="assets/images/about_2.jpg" alt="" />
							</figure>
							<div class="about_col">
					...
					<div class="col-lg-4 col-md-6 mt-sm-30">
						<div class="about_box">
							<figure><img src="assets/images/about_1.jpg" alt="" />
							</figure>
							<div class="about_col">
...
<!-- Project_sec_End -->
	...
	<!-- Team -->
  <div id="team" class="padding ptb-xs-40 grid">
    <div class="container">
      <div class="row pb-50 pb-xs-30">
					<div class="col-md-12">
						<div class="sec-title">
      ...
      <div class="row">
      	<div class="col-lg-3 col-md-6 mb-xs-30">
      		<div class="item">
          <div class="team-pic">
            <figure class="effect-zoe"> <img src="assets/images/team/team1.jpg" alt="" />
              <figcaption>
                <div class="name-block">
                  <h2>Jhon <span> Zoe</span></h2>
                  <span class="designation ">Engineer</span> </div>
                <p class="icon-links"> <a href="#"><span class="ion-social-facebook"></span></a> <a href="#"><span class="ion-social-twitter"></span></a> <a href="#"><span class="ion-social-whatsapp"></span></a> </p>
      	...
      	<div class="col-lg-3 col-md-6 mb-xs-30">
      		<div class="item">
          <div class="team-pic">
            <figure class="effect-zoe"> <img src="assets/images/team/team2.jpg" alt="" />
              <figcaption>
                <div class="name-block">
                  <h2>Jhon <span> Zoe</span></h2>
                  <span class="designation ">Engineer</span> </div>
      	...
      	<div class="col-lg-3 col-md-6 mt-sm-30 mb-xs-30">
      		<div class="item">
          <div class="team-pic">
            <figure class="effect-zoe"> <img src="assets/images/team/team3.jpg" alt="" />
              <figcaption>
                <div class="name-block">
                  <h2>Jhon <span> Zoe</span></h2>
                  <span class="designation ">Engineer</span> </div>
      	...
      	<div class="col-lg-3 col-md-6 mt-sm-30">
      		<div class="item">
          <div class="team-pic">
            <figure class="effect-zoe"> <img src="assets/images/team/team4.jpg" alt="" />
              <figcaption>
                <div class="name-block">
                  <h2>Jhon <span> Zoe</span></h2>
                  <span class="designation ">Engineer</span> </div>
		...
		<!--Video Sec-->
		<section class="padding ptb-xs-40 parallax video_sec">
		...
		<div class="row">
							<div class="col-lg-4 bg_black d-flex align-items-center">
								<div class="left_hedding padding-30 padding-xs-0">
									<h2>Looking For a Quality and Affordable Services</h2>
								</div>
							</div>
            ...
            <div class="container">
			 <div class="row pb-50 pb-xs-30">
                  ...
                  <div class="testimonial-box row">
                     <div class="col-md-5">
                        <img src="assets/images/testimonial/testimonial_2.jpg" alt="">
                     </div>
                     <div class="col-md-7">
                        <div class="quote-box">
                           ...
                           <div class="quote-icon quote-right"><i class="fa fa-quote-right" aria-hidden="true"></i>
                  ...
                  <div class="testimonial-box row">
                     <div class="col-md-5"> 
                        <img src="assets/images/testimonial/testimonial_1.jpg" alt="">
                     </div>
                     <div class="col-md-7">
                        <div class="quote-box">
                           <div class="quote-icon quote-left"><i class="fa fa-quote-left" aria-hidden="true"></i></div>
...
<!-- Project-->
	...
	<section class="latest__block padding ptb-xs-40 gray-bg">
		...
		<div class="img-scale">
		<figure>
		<img src="assets/images/blog/home_blog-1.jpg" alt="">
		</figure>
		...
		<div class="img-scale">
		<figure>
		<img src="assets/images/blog/home_blog-2.jpg" alt="">
		</figure>
		<div class="latest__block-post">
		<div class="meta-post">
		Jan, 24th 2018
		...
		<div class="img-scale">
		<figure>
		<img src="assets/images/blog/home_blog-3.jpg" alt="">
		</figure>
		<div class="latest__block-post">
		<div class="meta-post">
		Jan, 24th 2018
