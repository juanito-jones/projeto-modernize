...
<!--Start mainmenu area-->
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="heading-box pb-30">
								<h2>We are <span>Gardner</span></h2>
					...
					<div class="row">
						<div class="col-sm-3">
							<div class="single-fact">
								...
								<span class="counter" data-count="982">0</span>
								<p>
									Trees Planted
								</p>
							</div>
						...
						<div class="col-sm-3">
							<div class="single-fact">
								...
								<span class="counter" data-count="978">0</span>
								<p>
									Project Done
								</p>
							</div>
  ...
  <!-- End Team Section -->
			...
			<!-- Testimonial -->
			<section class="testimonial-section padding ptb-xs-60 light-color parallax overlay-dark ">
				<div class="container">
					<div class="row text-center pb-30">
						<div class="col-sm-12">
							<div class="heading-box withe-color pb-30">
