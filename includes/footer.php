    ...
    <div class="container">
        <div class="row footer-info mb-60">
            <div class="col-lg-3 col-md-4 col-xs-12 mb-sm-30">
                ...
                <ul class="link-small">
                    <li><a href="mailto:business@support.com"><i class="ion-ios-email fa-icons"></i> falecom@lojadopaisagista.com</a></li>
                    <li><a><i class="ion-ios-telephone fa-icons"></i> 41 3022 1925</a></li>
                </ul>
