					...
					<ul>
						...
						<li data-index="rs-129"  >
							...
							<div class="tp-caption Newspaper-Title tp-resizeme "
								...
								<div class="banner-text">
									<h2>Welcome to Garden <span>Services Company</span></h2>
						...
						<li data-index="rs-130" data-title="" data-description="">
							...
							<div class="tp-caption Newspaper-Title   tp-resizeme "
								 ...
								 data-responsive_offset="on">
								<div class="banner-text">
									<h2>Extend Your Home  <span> With a Beautiful Garden</span></h2>
									<p>
										Lorem Ipsum is simply dummy text of the printing and typesetting industry Lorem Ipsum has been the industry's standard dummy text ever.
									</p>
						...
						<li data-index="rs-131">
							<!-- MAIN IMAGE -->
							<img src="assets/images/banner/banner_img3.jpg"  alt=""   class="rev-slidebg " >
							<!-- LAYERS -->
							<!-- LAYER NR. 2 -->
							<div class="tp-caption Newspaper-Title   tp-resizeme "
								 ...
								 data-responsive_offset="on">
								<div class="banner-text">
									<h2>designing your   <span>dream garden</span></h2>
									<p>
										Lorem Ipsum is simply dummy text of the printing and typesetting industry Lorem Ipsum has been the industry's standard dummy text ever.
									</p>
									<a class="btn-text" href="about_us.html"> read more</a>
